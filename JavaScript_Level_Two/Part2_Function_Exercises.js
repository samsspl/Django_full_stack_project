...
function sleepIn(weekday, vacation) {
  ...
  if(weekday === true && vacation === false)
    goodDay = false;
    //console.log(goodDay); //checking at console.
    return goodDay;
}

sleepIn(false, false) //its weekend, sleepin no matter vac or not
sleepIn(false, true)  //its weekend, sleepin no matter vac or not
sleepIn(true, false)  //its weekday, and not vac so false 
sleepIn(true, true) //its weekday, and it is vac so true
...
function monkeyTrouble(aSmile, bSmile) {
    ...
    if((aSmile === true && bSmile === true) || (aSmile === false && bSmile === false))
      monkey = true;
    // console.log(monkey);  //checking at console.
    return monkey;
}

monkeyTrouble(true, true) //we are in trouble "true"
monkeyTrouble(true, false)
monkeyTrouble(false, true)
monkeyTrouble(false, false) //we are in trouble "true"
...
function stringTimes(str, n) {
  ...
  // console.log(tmp); //checking at console.
  return tmp;
}
stringTimes("Hi", 2) 
stringTimes("Hi", 3) 
...
function luckySum(a, b, c){
  ...
  // console.log(sum); //checking at console.
  return sum;
}
luckySum(1, 2, 3) 
luckySum(1, 2, 13)
